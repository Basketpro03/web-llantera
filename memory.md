...
### Pendientes
- [ ] **Favicon roto**: `<link rel="icon">` apunta a `Logo Solo S.png` que ya no existe. Opción fácil ahora: generar favicon desde `logo_outline_navbar.png` (ya tiene alpha real).
